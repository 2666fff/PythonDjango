...
public class alarmTesting extends Activity
{
  /* 声明对象变量 */
  TextView setTime1;
  TextView setTime2;
  ...
  public void onCreate(Bundle savedInstanceState)
  {
    ...
    btnPlay.setOnClickListener(new View.OnClickListener()
    {
      public void onClick(View v)
      {
        mPlayer = new MusicPlayer(alarmTesting.this);
    ...
    mButton1.setOnClickListener(new View.OnClickListener()
    {
      public void onClick(View v)
      {
        ...
        new TimePickerDialog(alarmTesting.this,
          ...
          {                
                                  ...
                                  int minute)
            {
              ...
              Intent intent = new Intent(alarmTesting.this, CallAlarm.class);
              /* 创建PendingIntent */
              PendingIntent sender=PendingIntent.getBroadcast(
                                     alarmTesting.this,0, intent, 0);
              ...
              /* 以Toast提示设置已完成 */
              Toast.makeText(alarmTesting.this,"设置闹钟时间为"+tmpS,
                Toast.LENGTH_SHORT)
                .show();
            }          
    ...
    mButton2.setOnClickListener(new View.OnClickListener()
    {
      public void onClick(View v)
      {
        ...
        Toast.makeText(alarmTesting.this,"闹钟时间解除",
    ...
    final AlertDialog di=new AlertDialog.Builder(alarmTesting.this)
          ...
          .setPositiveButton("确定",
            new DialogInterface.OnClickListener()
           {
             public void onClick(DialogInterface dialog, int which)
             {
               ...
               /* 指定闹钟设置时间到时要运行CallAlarm.class */
               Intent intent = new Intent(alarmTesting.this,
                                          CallAlarm.class);
               PendingIntent sender = PendingIntent.getBroadcast(
                                        alarmTesting.this,1, intent, 0);
