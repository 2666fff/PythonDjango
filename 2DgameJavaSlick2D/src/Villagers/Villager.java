...
public abstract class Villager extends Unit
{
	 ...
	 * @param gps The World, which acts as a facade. 
	 */
	public void update(int delta, World pos)
	{
		...
		if (pos.distanceTo(this, pos.getPlayer()) < interactDist)
		{
			if (!this.interacting)
			{
				this.interact(pos.getPlayer());
			}
		}
		else
		{
